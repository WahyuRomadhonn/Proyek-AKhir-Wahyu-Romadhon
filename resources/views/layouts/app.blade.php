        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                    <img src="https://st3.depositphotos.com/1561359/13079/i/1600/depositphotos_130798042-stock-photo-yellow-letter-w.jpg"
                         class="user-image img-circle elevation-2" alt="User Image">
                    <span class="d-none d-md-inline">Wahyu Romadhon</span>
                </a>
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <li class="user-header bg-primary">
                        ...
                        <p>
                            {{ Auth::user()->name }}
                            <small>Proyek_Akhir Framework {{ Auth::user()->created_at->format('M. Y') }}</small>
                        </p>
                    </li>
                    <!-- Menu Footer-->
